...
def get_departure_board(crs_code: str, token: str, num_rows: int | None =10, filter_crs: str | None = None) -> tuple[str, dt.datetime, list]:
    ...
    try:
        if filter_crs:
            ...
            res = client.service.GetDepartureBoard(numRows=num_rows, crs=crs_code, _soapheaders=[header_value])
